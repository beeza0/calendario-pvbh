export const events = [
    ...
    },
    {
      'title': 'Happy Hour',
      'bgColor': '#eee8aa',
      'start':new Date(2025, 3, 17, 17, 0, 0, 0),
      'end': new Date(2025, 3, 17, 17, 30, 0, 0),
      desc: 'Most important meal of the day'
    },
    {
      'title': 'Dinner',
      'bgColor': '#98fb98',
      'start':new Date(2025, 3, 15, 20, 0, 0, 0),
      'end': new Date(2025, 3, 15, 21, 0, 0, 0)
    },
    {
      'title': 'Birthday Party',
      'bgColor': '#afeeee',
      'start':new Date(2025, 3, 13, 7, 0, 0),
